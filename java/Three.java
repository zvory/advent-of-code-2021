...
public class Three {
    public static void main (String[] args){
        ...
        for (int i = 0; i < input[0].length(); i++) {
            ...
            if (zeroes > stillValidOxy.size()/2) {
                for (String command: input) {
                    if ('1' == command.charAt(i) && stillValidOxy.size() > 1){
                        stillValidOxy.remove(command);
                    } else if (stillValidCO.size() > 1) {
                        stillValidCO.remove(command);
                    }
                }
            } else {
                for (String command: input) {
                    if ('0' == command.charAt(i) && stillValidOxy.size() > 1){
                        stillValidOxy.remove(command);
                    } else if (stillValidCO.size() > 1) {
                        stillValidCO.remove(command);
                    }
        ...
        System.out.println("oxy: " + oxy + " co: " + co + " ans: " + oxy * co);
